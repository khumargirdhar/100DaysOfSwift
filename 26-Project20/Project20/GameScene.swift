...
//  Project20
//
//  Created by Khumar Girdhar on 31/05/21.
//
...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        scoreLabel.position = CGPoint(x: 512, y: 730)
    ...
    @objc func launchFireworks() {
        ...
        //Challenge 2
        if numberOfFireworks > 20 {                 //GameOver after 20 launches
    ...
    func explode(firework: SKNode) {
        if let emitter = SKEmitterNode(fileNamed: "explode") {
            ...
            //Challenge 3
            emitter.run(SKAction.wait(forDuration: 6)) {
