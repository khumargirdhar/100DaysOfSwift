...
class ImageViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Challenge 1
        guard let path = Bundle.main.path(forResource: image, ofType: nil) else { fatalError("Could'nt find path of the image.") }
        guard let original = UIImage(contentsOfFile: path) else { fatalError("Could'nt load image in ImageViewController") }
